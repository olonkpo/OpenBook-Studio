...
function buildMenu() {
  ...
  // Remove any existing handlers/listeners to prevent double-registration errors
  // (e.g. during hot-reload in development)
      ...
      submenu: [
        {
          ...
          click: () => shell.openExternal('https://github.com/olonkpo/OpenBook-Studio'),
        },
        { type: 'separator' },
        {
